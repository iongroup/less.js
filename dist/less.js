...
var options = (window && window.less) || {};
require("./add-default-options")(window, options);

var less = self.less1 = module.exports = require("./index")(window, options);

if (window && /!watch/.test(window.location.hash)) {
    less.watch();
}
...
function getXMLHttpRequest() {
    if (!window || window.XMLHttpRequest && (window.location.protocol !== "file:" || !("ActiveXObject" in window))) {
...
FileManager.prototype.doXHR = function doXHR(url, type, callback, errback) {
    ...
    if (_window_href && url.indexOf('://') < 0) {
        // Extract the scheme part
        var hostPart = this.extractUrlParts(_window_href).hostPart;
...
FileManager.prototype.loadFile = function loadFile(filename, currentDirectory, options, environment, callback) {
    ...
    options = options || {};
        ...
        var hrefParts = this.extractUrlParts(filename, window ? window.location.href : _window_href);
...
},{"asap":87}],90:[function(require,module,exports){
'use strict';
...
},{"./core.js":89,"asap":87}],91:[function(require,module,exports){
...
},{"./lib/core.js":89,"./lib/es6-extensions.js":90,"./polyfill-done.js":91,"asap":87}]},{},[2])("promise/polyfill.js")
});
